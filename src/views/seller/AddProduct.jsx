...
const AddProduct = () => {
  ...
  const add = (e) => {
    ...
    // Tambahkan validasi di sini untuk memastikan minimal 1 gambar
    if (images.length < 2) {
      toast.error("Pilih setidaknya dua gambar untuk diunggah.");
      return;
    }
    ...
    formData.append("shopName", "Difan Fashion");
